...
// 공지사항 등록
export const registerBoard = ({ email, title, content }) => {
    return client({
        url: `boards`,
        method: 'post',
...
// 공지사항 수정
export const modifyBoard = ({ boardId, email, title, content }) => {
    return client({
        url: `boards/${boardId}`,
        method: 'put',
        data: { email, title, content },
...
// 공지사항에 댓글 작성
export const registerBoardComment = ({ boardId, email, comment }) => {
    return client({
        url: `boards/${boardId}/comments`,
        method: 'post',
        data: { email, comment },
...
// 공지사항에 댓글 수정
export const modifyBoardComment = ({ boardId, commentId, email, comment }) => {
    return client({
...
// 공지사항에 댓글 삭제
export const deleteBoardComment = ({ boardId, commentId }) => {
    return client({
        url: `boards/${boardId}/comments/${commentId}`,
        method: 'delete',
    })
