...
public class ChallengeController {
    ...
    @PostMapping("/{challengeId}/{email}/{todo}")
    public ResponseEntity<ChallengeResponse> joinChallenge(@PathVariable("challengeId") Long challengeId, @PathVariable("email") String email, @PathVariable("todo") String todo)throws ParseException{
        return challengeService.joinChallenge(email, todo, challengeId);
    }
}
